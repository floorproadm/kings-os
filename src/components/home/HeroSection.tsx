...
export default function HeroSection() {
  return (
    <section className="relative h-[100svh] md:h-[80vh] flex items-end bg-background overflow-hidden">
      ...
      />
      {/* Gradient overlays */}
      {/* Desktop: subtle top/bottom fade */}
      <div className="hidden md:block absolute inset-0 bg-gradient-to-b from-background via-transparent via-15% to-background to-90%" />
      {/* Mobile: strong top fade (100% bg) to transparent (0%) at bottom */}
      <div className="absolute inset-0 md:hidden bg-gradient-to-b from-background via-background/60 via-40% to-transparent" />
