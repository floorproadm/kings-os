...
export default function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50">
        ...
        <div className="container mx-auto flex items-center justify-between px-4 py-2 text-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              aria-label="Nextdoor"
            >
              <img src={nextdoorIcon} alt="Nextdoor" className="w-4 h-4 opacity-70" />
            </a>
            <a
      ...
      {/* Main Nav */}
      <header className={`border-b border-border/30 transition-colors duration-300 py-3 ${scrolled ? "bg-background/95 backdrop-blur-md shadow-lg shadow-black/10" : "bg-background/80 backdrop-blur-sm"}`}>
