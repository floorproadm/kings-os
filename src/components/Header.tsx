        ...
        <div className="container mx-auto flex items-center justify-between px-4 transition-all duration-300">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-1 w-64 bg-background/80 backdrop-blur-md backdrop-saturate-150 border border-white/10 rounded-xl shadow-2xl shadow-black/40 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 py-2">
                {services.map((s) => (
                  <Link
                    key={s.path}
                    to={s.path}
