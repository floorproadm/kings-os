        ...
        >
          ...
          >
            <form
              ...
              className="bg-background rounded-2xl p-6 sm:p-8 space-y-4 w-full"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <input type="tel" placeholder="(913) 000-0000" value={form.phone} onChange={(e) => update("phone", formatPhone(e.target.value))} className={inputCls} />
              </div>
