      ...
      <section className="section-padding bg-gradient-to-r from-gold-light/80 via-gold/70 to-gold-dark/80">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="xl" className="bg-background border-2 border-black gold-gradient-text hover:border-gold/50 hover:shadow-[0_0_15px_rgba(201,168,76,0.15)] transition-all" asChild>
