      ...
      <section className="relative section-padding overflow-hidden">
        ...
        <div className="relative container mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <p className="text-xs uppercase tracking-[0.3em] text-background/60 font-semibold mb-4">Demolition & Replacement</p>
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-background mb-5">Ready for a Fresh Start?</h2>
            <div className="w-16 h-[2px] bg-background/30 mx-auto mb-5" />
            <p className="text-background/70 mb-10 max-w-lg mx-auto text-sm leading-relaxed">Let us handle the heavy lifting. Get a free estimate for your demolition and replacement project.</p>
          </motion.div>
